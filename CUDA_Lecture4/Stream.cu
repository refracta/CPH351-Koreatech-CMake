...
int main(void) {
    DS_timer timer(10);
    timer.setTimerName(0, (char *) "Single stream");
    timer.setTimerName(1, (char *) "  * Host -> Device");
    timer.setTimerName(2, (char *) "  * Kernel execution");
    timer.setTimerName(3, (char *) "  * Device -> Host");
    timer.setTimerName(4, (char *) "Multiple streams");
