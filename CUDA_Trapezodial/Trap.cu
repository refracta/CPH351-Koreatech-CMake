...
int main(void) {
    ...
    timer.setTimerName(1, (char *) "[Atomic on Global Mem.]");
    timer.setTimerName(2, (char *) "[Shared Ver1. Atomic Op. on a variable ]");
    timer.setTimerName(3, (char *) "[Shared Ver2. Master-Slave]");

    timer.setTimerName(4, (char *) "[Shared Ver3. Reduction]");
    timer.setTimerName(5, (char *) "[Shared Ver4. Reduction - Avoid Bank conflict]");
    timer.setTimerName(6, (char *) "[Shared Ver5. Reduction - Loop unrolling (warp)]");
    timer.setTimerName(7, (char *) "[Shared Ver6. Reduction - Loop unrolling (block)]");
