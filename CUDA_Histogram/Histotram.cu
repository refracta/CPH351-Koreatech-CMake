...
int main(void) {
    DS_timer timer(10);
    timer.initTimers();
    timer.setTimerName(1, (char *) "[No Sync.]");
    timer.setTimerName(2, (char *) "[Global Sync.]");
    timer.setTimerName(3, (char *) "[Shared Sync. -> Global Sync.]");
    timer.setTimerName(8, (char *) "- Host -> Device");
    timer.setTimerName(9, (char *) "- Devic -> Host");
