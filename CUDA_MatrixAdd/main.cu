...
int main(void) {
    ...
    memset(A, 0, sizeof(float) * MAT_SIZE);
    B = new float[MAT_SIZE];
    memset(B, 0, sizeof(float) * MAT_SIZE);
    C = new float[MAT_SIZE];
    memset(C, 0, sizeof(float) * MAT_SIZE);
    hC = new float[MAT_SIZE];
    memset(hC, 0, sizeof(float) * MAT_SIZE);
