...
enum Algorithm {
    Serial,
    ImplicitBarrier_NoSync,
    ImplicitBarrier,
    ImplicitBarrier_SharedLocalVar,
    Atomic,
    Critical,
    Locking,
    Reduction,
...
int main(int argc, char *argv[]) {
    ...
    timer.setTimerName(Algorithm::Serial, (char *) "[Baseline] Serial algorithm");
    timer.setTimerName(Algorithm::ImplicitBarrier_NoSync, (char *) "[Parallel]Implicit barrier w/o Sync.");
    timer.setTimerName(Algorithm::ImplicitBarrier, (char *) "[Parallel]Implicit barrier");
    timer.setTimerName(Algorithm::ImplicitBarrier_SharedLocalVar,
                       (char *) "[Parallel] Implicit barrier (Shared local Var)");
    timer.setTimerName(Algorithm::Atomic, (char *) "[Parallel] Atomic for sum");
    timer.setTimerName(Algorithm::Critical, (char *) "[Parallel] Critical for sum");
    timer.setTimerName(Algorithm::Locking, (char *) "[Parallel] Locking for sum");
    timer.setTimerName(Algorithm::Reduction, (char *) "[Parallel] Using reduction");
...
#pragma omp for
    ...
    LOOP_I(NUM_THREADS) sum += local[i * offset];
